export default {
	...
	"features.sectionDescription": {
		...
		de: "Das maßgebliche Ziel für RedakTool ist es, aus KI-Modellen maximal gute Schreibqualität herauszuholen. Hierfür werden pro Aufgabe dynamisch Instruktionen aus Prompt-Vorlagen erstellt. Mit guter Parametrisierung per API und Ihren persönlichen Stilbeispielen bringt RedakTool die KI auf eine bessere Spur. Mit der Zeit lernt RedakTool noch mehr über Ihren Schreibstil und kann Ihnen so immer bessere Ergebnisse liefern.",
	},
	"features.badgeText": {
		en: "Goals, Features, Milestones",
		de: "Ziele, Funktionen, Meilensteine",
	},
	...
	"features.featureBadgeTextNew": {
		en: "M. 3-4",
		de: "M. 3-4",
	},
	"features.featureBadgeTextBeta": {
		en: "M. 5-6",
		de: "M. 5-6",
	},
	"features.insightsTitle": {
		en: "Research",
		de: "Recherche",
	},
	"features.meaningfulTitle": {
		en: "Multi-AI Adapter",
		de: "Multi-KI-Adapter",
	},
	"features.meaningfulDescription": {
		en: "RedakTool's interface for communication with AI models is abstractly implemented in the Service Worker. The browser extension interacts with various AI models running on provider servers or locally. Configurations are available for OpenAI, Anthropics, Google, Cohere, HuggingFace, Ollama, and any services supporting the Messages API.",
		de: "In RedakTool ist die Schnittstelle zur Kommunikation mit KI-Modellen abstrakt im Service Worker implementiert. Die Browser-Erweiterung kommuniziert so mit vielen KI-Modellen, die auf den Servern der Anbieter oder auch lokal laufen. OpenAI, Anthropics, Google, Cohere, HuggingFace, Ollama und alle Services, welche die Messages API unterstützen, können konfiguriert werden.",
	},
	"features.visionEnabledTitle": {
		en: "Browser Vector Database",
	...
	"features.insightsDescription": {
		...
		de: "Von Content-Extraktion über NewsRadar-Modul bis Transkription: RedakTool bietet Ihnen eine Vielzahl von Funktionen, um Ihre Recherche zu unterstützen. Dabei helfen Prompts, die speziell für den journalistischen Bereich entwickelt und getestet wurden.",
	},
	"features.interactiveDashboardTitle": {
		en: "NewsRadar",
		de: "NewsRadar",
	},
	...
	"features.multiTenantDescription": {
		en: "Our systems are multi-tenant capable, allowing you to manage multiple branches with a single account.",
		de: "Unsere Systeme sind mandantenfähig. Das bedeutet, dass Sie mehrere Zweigstellen mit einem Konto verwalten können.",
	},
	...
	"features.customizationDescription": {
		en: "Every business faces unique challenges. As part of our enterprise plan, we work with you to tailor our systems to meet your needs.",
		de: "Jedem Unternehmen begegnen einzigartige Herausforderungen. Als Teil unseres Enterprise-Angebots arbeiten wir mit Ihnen daran, unsere Systeme für Sie maßgeschneidert zu gestalten.",
	},
};
